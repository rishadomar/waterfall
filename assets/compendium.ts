    ...
    stories: [
            ...
            pages: [
                {
                    ...
                    text: [
                        {
                            line: 'We set out on a journey to find the start of a waterfall.',
                ...
                },
                {
                    ...
                    text: [
                        {
                            line: 'Our adventure begins with a steep climb up the mountain.',
                            audio: require('./pages/2a.mp3')
                        },
                        {
                            line: 'We take it one step at a time, making sure to rest and catch our breath when we need to.',
                ...
                },
                {
                    ...
                    text: [
                        {
                            line: 'As we continue up the path, we come across a fallen tree that we have to climb over.',
                            audio: require('./pages/3a.mp3')
                        },
                        {
                            line: "It's a bit of a challenge, but we help each other over and keep moving forward.",
                ...
                },
                {
                    ...
                    text: [
                        {
                            line: 'The forest is alive with the sweet sound of singing birds.',
                            audio: require('./pages/4a.mp3')
                        },
                        {
                            line: "We can't see them, but we know they're there, hidden away in the trees.",
                ...
                },
                {
                    ...
                    text: [
                        {
                            line: 'The path is soft and bouncy underfoot, littered with fallen leaves and sticks.',
                            audio: require('./pages/5a.mp3')
                        },
                        {
                            line: "It feels like we're walking on a natural trampoline.",
                ...
                {
                    pageNumber: 6,
                    text: [{ line: 'Soon, we reach a bridge that spans a river.', audio: require('./pages/6.mp3') }],
                ...
                },
                {
                    ...
                    text: [
                        {
                            line: 'We pause to take in the refreshing coolness of the shade, listening to the rustling leaves overhead.',
                            audio: require('./pages/7a.mp3')
                        },
                        {
                            line: 'The air is fresh and invigorating, and we take deep, long breaths to fill our lungs.',
                ...
                },
                {
                    ...
                    text: [
                        {
                            line: 'At last, we reach our destination: the breathtaking waterfall.',
                            audio: require('./pages/8a.mp3')
                        },
                        {
                            line: 'The water gushes down, creating a beautiful sight to behold.',
                ...
                },
                {
                    ...
                    text: [
                        {
                            line: 'We take a well-deserved break to drink some water and eat some fruit, savoring the natural beauty that surrounds us.',
                ...
                },
                {
                    ...
                    text: [
                        {
                            line: 'As we make our way back, we cross the stream by stepping on stones, taking care not to slip.',
                ...
                },
                {
                    ...
                    text: [
                        {
                            line: 'We begin our descent down the mountain, the path winding its way back down.',
                            audio: require('./pages/11a.mp3')
                        },
                        {
                            line: 'We take our time, enjoying the peacefulness and tranquility of the forest.',
                            audio: require('./pages/11b.mp3')
                        },
                        {
                            line: "Our adventure comes to an end as we reach the bottom of the mountain, feeling grateful for the beautiful journey we've experienced together.",
        ...
        },
        {
            ...
            pages: [
                {
                    pageNumber: 1,
                    text: [{ line: "Yay we're going to the beach!", audio: require('./pages/1.mp3') }],
                    image: require('./pages/pathToTheForest.png'),
                    tweets: [1]
                }
            ]
